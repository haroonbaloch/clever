<?php
   ...
   Redux::setSection( $opt_name, array(
    ...
    Redux::setSection( $opt_name, array(
        ...
        array(
                'id'       => 'phone_line',                               
                'title'    => esc_html__( ' Phone Line', 'braintech' ),
        ...
        array(
            'id'       => 'top_address',                               
            'title'    => esc_html__( 'Address Address', 'braintech' ),
...
//End Preloader settings  
    // -> START Style Section
    Redux::setSection( $opt_name, array(
        'title'            => esc_html__( 'Style', 'braintech' ),
        'id'               => 'stle',
        'customizer_width' => '450px',
        'icon' => 'el el-brush',
        ));
    ...
    //Menu settings
    Redux::setSection( $opt_name, array(
        'title'  => esc_html__( 'Main Menu', 'braintech' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
                                ...
                                array(
                                    'id'               => 'blog-date',
                                    'type'             => 'switch',
                                    'title'            => esc_html__('Show Date', 'braintech'),                   
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(                            
                           ...
                           array(
                               'id'       => 'blog-author',
                               'type'     => 'switch', 
                               'title'    => esc_html__('Show Meta', 'braintech'),
    ...
    /*Service Sections*/
    Redux::setSection( $opt_name, array(
        'title'            => esc_html__( 'Service Section', 'braintech' ),
        'id'               => 'service',
        'customizer_width' => '450px',
        ...
        'fields'           => array(
            ...
            array(
                    ...
                    'url'      => true,     
                    'title'    => esc_html__( 'Service Single page banner image', 'braintech' ),                    
                    'type'     => 'media',
            ...
            array(
                    'id'       => 'service_slug',                               
                    'title'    => esc_html__( 'Service Slug', 'braintech' ),
                    'subtitle' => esc_html__( 'Enter Service Slug Here', 'braintech' ),
                    'type'     => 'text',
                    'default'  => 'service',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
                    array(
                     ...
                     array(
                        'id'       => 'google',                               
                        'title'    => esc_html__( 'Google Plus Link', 'braintech' ),
                        'subtitle' => esc_html__( 'Enter Google Plus  Link', 'braintech' ),
                        'type'     => 'text',                       
                    ),
